package com.example.unidad6_ej2;
...
public class Unidad6Ej2Application {

    public static void main(String[] args) {
        SpringApplication.run(Unidad6Ej2Application.class, args);

    ApplicationContext context = SpringApplication.run(Unidad6Ej2Application.class, args);
